...
class GoForwardAndTurn():
    def __init__(self):
        ...
        first_goal.target_pose.pose.position.x = 2.85
...
#   # # Define and send the second goal to move left by 1 meter
#         fifth_goal = MoveBaseGoal()
#         fifth_goal.target_pose.header.frame_id = 'base_link'
#         fifth_goal.target_pose.header.stamp = rospy.Time.now()
#         fifth_goal.target_pose.pose.position.x = 1
#         fifth_goal.target_pose.pose.orientation.w = 0.5
#         self.move_base.send_goal(fifth_goal)
#         success = self.move_base.wait_for_result(rospy.Duration(60))
